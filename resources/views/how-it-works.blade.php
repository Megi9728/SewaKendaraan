...
@section('content')
    ...
    <section class="pt-28 pb-16 lg:pt-36 lg:pb-24 bg-[#F9F9F5] relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <a href="{{ route('browse') }}"
                class="inline-flex items-center justify-center bg-[#0A174E] hover:bg-[#F5D042] text-white hover:text-[#0A174E] font-bold px-8 py-4 rounded-xl transition-colors shadow-[0_4px_15px_rgba(10,23,78,0.2)]">
                Cari Kendaraan <i class="fas fa-arrow-right ml-3 -mt-0.5"></i>
            </a>
        </div>
    </section>
    ...
    <section class="py-24 bg-[#F9F9F5]">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16 max-w-3xl mx-auto">
                ...
                <p class="text-lg text-[#8F8F7E] font-medium">Bukan sekadar rental, kami menghadirkan pengalaman perjalanan
                    berkelas untuk Anda.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Keunggulan 1 -->
                <div
                    class="bg-white p-10 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#EBEBDF] hover:border-[#F5D042] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                    <div
                        class="w-16 h-16 bg-[#0A174E]/5 rounded-2xl flex items-center justify-center text-[#0A174E] text-2xl mb-8 group-hover:bg-[#0A174E] group-hover:text-[#F5D042] transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                ...
                <div class="w-full lg:w-1/2 relative group">
                    <div
                        class="absolute -inset-4 bg-[#F5D042] rounded-[3rem] transform rotate-3 opacity-20 group-hover:rotate-6 transition-all duration-500">
                    </div>
                    <div
                    ...
                    {{-- Pop-up mini --}}
                    <div class="absolute bottom-10 -right-5 z-40 bg-white p-5 rounded-2xl shadow-xl flex items-center gap-4 animate-bounce"
                ...
                <div class="w-full lg:w-1/2">
                    <h2 class="text-3xl md:text-5xl font-extrabold text-[#0A174E] mb-6 tracking-tight leading-tight">
                        ...
                        <span class="text-[#F5D042] relative inline-block">
                            Hanya 4 Langkah.
                            <svg class="absolute w-full h-3 -bottom-1 left-0 text-[#F5D042]/30" viewBox="0 0 100 20"
                                preserveAspectRatio="none">
                                <path d="M0 10 Q50 20 100 10" stroke="currentColor" stroke-width="4" fill="none" />
                            </svg>
                        </span>
                    </h2>
                    <p class="text-lg text-[#8F8F7E] mb-12 font-medium">Beralih dari formulir kertas yang menyebalkan ke
                        sistem reservasi berkecepatan tinggi.</p>
                        ...
                        <div class="space-y-8">
                            @php
                                $steps = [
                                    ...
                                    [
                                        ...
                                        'title' => '2. Atur Jadwal',
                                        'desc' =>
                                            'Tentukan tanggal sewa dan lokasi penjemputan sesuai kebutuhan perjalanan Anda.',
                                    ],
                                    [
                                        'icon' => 'fa-id-card',
                            ...
                            @foreach ($steps as $step)
                                <div class="flex gap-6 group relative z-20">
                                    <div
                                        class="flex-shrink-0 w-16 h-16 rounded-full bg-white border-4 border-[#F9F9F5] shadow-lg flex items-center justify-center group-hover:border-[#F5D042] transition-colors duration-300">
                                        <div
                                            class="w-10 h-10 rounded-full bg-[#0A174E] text-[#F5D042] flex items-center justify-center text-lg group-hover:bg-[#F5D042] group-hover:text-[#0A174E] transition-colors duration-300">
                                            <i class="fas {{ $step['icon'] }}"></i>
                                        </div>
                                    </div>
                                    <div class="pt-2">
                                        <h4 class="text-2xl font-extrabold text-[#0A174E] mb-2 tracking-tight">
                                            {{ $step['title'] }}</h4>
                                        <p class="text-[#8F8F7E] leading-relaxed text-lg font-medium">{{ $step['desc'] }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
    ...
    <section class="py-24 bg-[#F9F9F5]">
        <div class="max-w-4xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2
                    class="text-3xl md:text-5xl font-extrabold text-[#0A174E] mb-4 tracking-tight border-b-4 border-[#F5D042] pb-6 inline-block w-48">
                    FAQ Utama</h2>
                <p class="text-lg text-[#8F8F7E] font-medium mt-6">Solusi cepat untuk Anda terkait rental kendaraan Jatara.
                </p>
            </div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl p-8 border border-[#EBEBDF] shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-start gap-4">
                        <div class="text-[#F5D042] text-2xl mt-1"><i class="fas fa-question-circle text-[#0A174E]"></i>
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl p-8 border border-[#EBEBDF] shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h4 class="font-extrabold text-[#0A174E] text-xl mb-3">Bolehkah saya membawa kendaraan ke luar
                                kota/provinsi?</h4>
                            <p class="text-[#8F8F7E] text-lg font-medium leading-relaxed">
                                Area penggunaan (Coverage Area) tergantung pada kebijakan spesifik setiap Mitra Jatara.
                                Umumnya Anda dibebaskan (Unlimited Mileage) untuk area dalam kota raya (seperti
                                Jabodetabek), namun diwajibkan melapor untuk rute jarak jauh antar provinsi.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            <div class="bg-[#0A174E] rounded-[3rem] p-12 md:p-20 shadow-2xl relative overflow-hidden">
                <!-- decorative circles -->
                <div
                    class="absolute -top-24 -left-24 w-64 h-64 border-[40px] border-white/5 rounded-full pointer-events-none">
                </div>
                <div
                    class="absolute -bottom-24 -right-24 w-64 h-64 border-[40px] border-[#F5D042] rounded-full opacity-20 pointer-events-none">
                </div>
                ...
                <div class="relative z-10 flex flex-col sm:flex-row justify-center gap-6">
                    ...
                    <a href="{{ route('register') }}"
                        class="bg-transparent border-2 border-white/20 text-white font-extrabold px-10 py-5 rounded-2xl hover:bg-white hover:text-[#0A174E] hover:border-white transition-colors shadow-lg">Buat
                        Akun Baru</a>
                </div>
            </div>
        </div>
