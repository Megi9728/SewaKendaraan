        ...
        <nav class="py-4">
            ...
            <ul class="flex flex-col gap-1.5">
                ...
                @else
                    @php
                        $mitraMenus = [
                            ['route' => 'mitra.dashboard', 'icon' => 'fas fa-gauge-high', 'label' => 'Dashboard Mitra'],
        ...
        <div class="bg-white/5 rounded-2xl p-4 border border-white/5 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-3 relative z-10">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[9px] font-medium text-gray-500 uppercase tracking-wider truncate">{{ Auth::user()->role }}</p>
                </div>
            </div>
